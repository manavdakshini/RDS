...
1. The nano editor will open the **dbinfo.inc** file. Add the following content into the file and replace the **db_instance_endpoint** to the ednpoint of your Database instance which you noted in the last exercise and **tutorial_user** to the username of your database, i.e. **admin**. Replace **master password** to the password you set while creating the database, i.e. **admin123**.
...
1. The nano editor will open the **SamplePage.php** file. Add the following content into it:
    ...
    * The keyword **TableExists** checks if a table exists in the database.
